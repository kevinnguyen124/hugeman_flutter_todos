...
class MockTodoGatewayImplImpl extends Mock implements TodoGatewayImpl {}
...
void main() {
  ...
  late TodoGatewayImpl todoGateway;

  group('TodosOverviewPage', () {
    setUp(() {
      todoGateway = MockTodoGatewayImpl();
      when(todoGateway.getTodos).thenAnswer((_) => const Stream.empty());
    });
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        verify(() => todoGateway.getTodos()).called(1);
      },
    );
  });
